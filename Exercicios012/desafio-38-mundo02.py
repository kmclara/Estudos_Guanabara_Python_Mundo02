...
#Verificando quais são maior, menor e igual: 
...
if número_usuário_um>número_usuário_dois: 
...
if número_usuário_um == número_usuário_dois: 
    ...
    print("Ambos os números {} e {} são valores iguais!".format(número_usuário_dois, número_usuário_um))
